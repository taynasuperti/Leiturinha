    ...
    public partial class NewMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Ziraldo", "~/img/1/o-menino-maluquinho1.jpg", 2, "Um garoto cheio de energia e criatividade, o Menino Maluquinho vive aprontando travessuras, inventando brincadeiras e alegrando todos ao redor. Entre versinhos, canções e confusões, ele mostra que ser feliz é estar cercado de amigos e amor.", false, 1, "O Menino Maluquinho" },
                    { 2, "Ziraldo", "~/img/2/maluquinho-de-familia1.jpg", 3, "Tudo começa com um trabalho escolar: a professora pede uma pesquisa sobre a família real do Brasil. A turma se diverte revelando suas origens, mas o Menino Maluquinho não sabe nada sobre sua árvore genealógica. A partir daí, ele embarca numa aventura com o álbum de fotos antigas do avô, descobrindo memórias familiares e percebendo que a maluquice está em seu DNA.", false, 1, "Maluquinho de família" },
                    { 3, "Molly Wigand", "~/img/3/como-ser-amigo1.jpg", 4, "Em Como ser amigo - Um livro sobre amizade... Feito pra mim!, a autora Molly Wigand apresenta às crianças os valores que ajudam a construir boas amizades: lealdade, verdade e honestidade. E como as crianças podem se tornar boas amigas umas das outras.", false, 5, "Como ser Amigo: um Livro Sobre Amizade" },
                    ...
                    { 5, "Tatiana Belinky", "~/img/5/a-cesta-da-dona-maricota1.jpg", 3, "Em deliciosos versos e rimas, os alimentos que compõem a cesta de Dona Maricota chegam da feira e iniciam uma gostosa provocação, enumerando as vantagens nutritivas de se comer, verduras, frutas e legumes.Indicado para os anos iniciais do Ensino Fundamental 1º ano e 2º ano, com trabalho interdisciplinar: Ciências da Natureza.", false, 1, "A cesta de dona Maricota" },
                    { 6, "Emília Nuñez", "~/img/6/a-ursinha-que-nao-dormia-sozinha1.jpg", 2, "Dormir na cama dos pais é uma delícia! Mas os pequenos crescem e chega o momento de dormir na sua própria caminha. Nesta história, Ursita e sua família encontram juntos a confiança para que a filhotinha durma sozinha e tenha sonhos tranquilos!", false, 1, "A ursinha que não queria dormir sozinha" },
                    { 7, "Neil Gaiman", "~/img/7/o-reizinho-mandao1.jpg", 5, "Certas portas não devem ser abertas. E Coraline descobre isso pouco tempo depois de chegar com os pais à sua nova casa, um apartamento em um casarão antigo ocupado por vizinhos excêntricos e envolto por uma névoa insistente, um mundo de estranhezas e magia, o tipo de universo que apenas Neil Gaiman pode criar.\r\n\r\nAo abrir uma porta misteriosa na sala de casa, a menina se depara com um lugar macabro e fascinante. Ali, naquele outro mundo, seus outros pais são criaturas muito pálidas, com botões negros no lugar dos olhos, sempre dispostos a lhe dar atenção, fazer suas comidas preferidas e mostrar os brinquedos mais divertidos. Coraline enfim se sente... em casa. Mas essa sensação logo desaparece, quando ela descobre que o lugar guarda mistérios e perigos, e a menina se dá conta de que voltar para sua verdadeira casa vai ser muito mais difícil ― e assustador ― do que imaginava.", false, 1, "Coraline" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "~/img/2/maluquinho-de-familia2.jpg", "Contra capa", 2 },
                    { 3, "~/img/3/como-ser-amigo2.jpg", "Contra capa", 3 },
                    { 4, "~/img/4/o-tesouro-da-raposa2.jpg", "Contra capa", 4 },
                    { 5, "~/img/5/a-cesta-da-dona-maricota2.jpg", "Contra capa", 5 },
                    { 6, "~/img/5/a-cesta-da-dona-maricota3.jpg", "Contra capa", 5 },
                    { 7, "~/img/6/a-ursinha-que-nao-dormia-sozinha2.jpg", "Contra capa", 6 },
                    { 8, "~/img/6/a-ursinha-que-nao-dormia-sozinha3.jpg", "Contra capa", 6 },
                    { 9, "~/img/7/o-reizinho-mandao2.jpg", "Contra capa", 7 },
                    { 10, "~/img/8/as-aventuras-de-nino2.jpg", "Contra capa", 8 },
                    { 11, "~/img/9/menina-bonita-do-laco-de-fita2.jpg", "Contra capa", 9 },
                    { 12, "~/img/9/menina-bonita-do-laco-de-fita3.jpg", "Contra capa", 9 },
                    { 13, "~/img/9/menina-bonita-do-laco-de-fita4.jpg", "Contra capa", 9 },
                    { 14, "~/img/12/o-pedido-da-fada-madrinha2.jpg", "Contra capa", 12 },
                    { 15, "~/img/12/o-pedido-da-fada-madrinha3.jpg", "Contra capa", 12 },
                    { 16, "~/img/12/o-pedido-da-fada-madrinha4.jpg", "Contra capa", 12 },
                    { 17, "~/img/13/chapeuzinho-vermelho2.jpg", "Contra capa", 13 },
                    { 18, "~/img/13/chapeuzinho-vermelho3.jpg", "Contra capa", 13 },
                    { 19, "~/img/15/a-primaveira-da-lagarta2.jpg", "Contra capa", 15 },
                    { 20, "~/img/16/joao-e-o-pe-de-feijao2.jpg", "Contra capa", 16 },
                    { 21, "~/img/16/joao-e-o-pe-de-feijao3.jpg", "Contra capa", 16 },
                    { 22, "~/img/16/joao-e-o-pe-de-feijao4.jpg", "Contra capa", 16 },
                    { 23, "~/img/17/os-tres-porquinhos2.jpg", "Contra capa", 17 },
                    { 24, "~/img/17/os-tres-porquinhos3.jpg", "Contra capa", 17 },
                    { 25, "~/img/17/os-tres-porquinhos4.jpg", "Contra capa", 17 },
                    { 26, "~/img/18/o-pequeno-principe2.jpg", "Contra capa", 18 },
                    { 27, "~/img/18/o-pequeno-principe3.jpg", "Contra capa", 18 },
                    { 28, "~/img/19/o-patinho-feio2.jpg", "Contra capa", 19 },
                    { 29, "~/img/21/a-cigarra-e-a-formiga2.jpg", "Contra capa", 21 },
                    { 30, "~/img/23/a-lebre-e-a-tartaruga2.jpg", "Contra capa", 23 },
                    { 31, "~/img/23/a-lebre-e-a-tartaruga3.jpg", "Contra capa", 23 },
                    { 32, "~/img/24/fabulas-de-escopo2.jpg", "Contra capa", 24 },
                    { 33, "~/img/25/perigoso-contem-coelhos2.jpg", "Contra capa", 25 },
                    { 34, "~/img/25/perigoso-contem-coelhos3.jpg", "Contra capa", 25 },
                    { 35, "~/img/27/a-raposa-e-as-uvas2.jpg", "Contra capa", 27 },
                    { 36, "~/img/30/simao-e-o-osso2.jpg", "Contra capa", 30 },
                    { 37, "~/img/30/simao-e-o-osso3.jpg", "Contra capa", 30 },
                    { 38, "~/img/33/dragoes-de-terrazul2.jpg", "Contra capa", 33 },
                    { 39, "~/img/33/dragoes-de-terrazul3.jpg", "Contra capa", 33 },
                    { 40, "~/img/33/dragoes-de-terrazul4.jpg", "Contra capa", 33 },
                    { 41, "~/img/34/chorar-e-como-chover2.jpg", "Contra capa", 34 },
                    { 42, "~/img/34/chorar-e-como-chover3.jpg", "Contra capa", 34 },
                    { 43, "~/img/34/chorar-e-como-chover4.jpg", "Contra capa", 34 },
                    { 44, "~/img/35/maluquinho-de-familia2.jpg", "Contra capa", 35 },
                    { 45, "~/img/35/maluquinho-de-familia3.jpg", "Contra capa", 35 },
                    { 46, "~/img/35/maluquinho-de-familia4.jpg", "Contra capa", 35 },
                    { 47, "~/img/37/zumbi-net2.jpg", "Contra capa", 37 },
                    { 48, "~/img/37/zumbi-net3.jpg", "Contra capa", 37 },
                    { 49, "~/img/38/gildo2.jpg", "Contra capa", 38 },
                    { 50, "~/img/39/o-reino-do-tempo2.jpg", "Contra capa", 39 },
                    { 51, "~/img/40/alice-no-pais-das-maravilhas2.jpg", "Contra capa", 40 },
                    { 52, "~/img/40/alice-no-pais-das-maravilhas3.jpg", "Contra capa", 40 },
                    { 53, "~/img/40/alice-no-pais-das-maravilhas4.jpg", "Contra capa", 40 },
                    { 54, "~/img/41/a-arca-de-noe2.jpg", "Contra capa", 41 },
                    { 55, "~/img/42/som-do-rugido-da-onca2.jpg", "Contra capa", 42 },
                    { 56, "~/img/42/som-do-rugido-da-onca3.jpg", "Contra capa", 42 },
                    { 57, "~/img/42/som-do-rugido-da-onca4.jpg", "Contra capa", 42 },
                    { 58, "~/img/43/cantigas-de-roda3.jpg", "Contra capa", 43 },
                    { 59, "~/img/44/mas-que-festa2.jpg", "Contra capa", 44 },
                    { 60, "~/img/44/mas-que-festa3.jpg", "Contra capa", 44 },
                    { 61, "~/img/44/mas-que-festa4.jpg", "Contra capa", 44 },
                    { 62, "~/img/45/o-caso-dos-ovos2.jpg", "Contra capa", 45 },
                    { 63, "~/img/46/catigamente2.jpg", "Contra capa", 46 },
                    { 64, "~/img/47/versos-magicos2.jpg", "Contra capa", 47 },
                    { 65, "~/img/48/poemas-para-brincar2.jpg", "Contra capa", 48 },
                    { 66, "~/img/50/jardins2.jpg", "Contra capa", 50 }
                });
