        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 13, "Susie Brooks", "~/img/13/chapeuzinho-vermelho1.jpg", 1, "Muito contente, CHAPEUZINHO VERMELHO foi vistar a vovozinha, mas não imaginava que o LOBO MAU estava no lugar da velhinha!", true, 2, "Chapeuzinho Vermelho" },
                    ...
                    { 22, "Avelino Guedes", "~/img/22/o-sanduiche-da-maricota.jpg", 3, "A galinha Maricota preparou um sanduíche. Mas, antes de conseguir comer, a bicharada toda começou a chegar e dar palpite para tornar o sanduíche da Maricota mais gostoso (para eles, é claro). O resultado é difícil de explicar. Só mesmo vendo. Vamos ver?", true, 3, "O sanduíche da Maricota" },
                    ...
                    { 25, "Tim Warnes", "~/img/25/perigoso-contem-coelhos1.jpg", 3, "O melhor amigo do Bob,uma coisa escamosa,encontrou um chapéu.Havia uma etiqueta nele que dizia:PERIGO! NÃO TOQUE! Tire isso! gritou Bob. Pode ser perigoso!Então, de dentro da cartola saltou um coelho.E depois outro! E outro!Mas os coelhos não são perigosos. São?Uma história hilária sobre amizade.E rótulos...", true, 3, "Perigoso! Este Livro Contém Coelhos!" },
                    ...
                    { 46, "Leo Cunha", "~/img/46/catigamente1.jpg", 3, "Os poemas de Leo Cunha refletem o mundo das crianças e desenvolvem nelas o gosto pela palavra. Os assuntos desses poemas foram retirados do universo infantil, com um olhar sensível e encantador.", true, 5, "Cantigamente" },
